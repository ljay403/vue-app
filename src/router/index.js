...
const routes = [
  ...
  { 
    ...
    children: [
      { path: "/index", name: "index", meta: { title: "系统首页" }, component: () => import("../views/Index/Index.vue") },
      { path: "/weatherstation", name: "weatherstation", meta: { title: "气象站" }, component: () => import("../views/WeatherStation/WeatherStation.vue") },
